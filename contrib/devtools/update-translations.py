...
SOURCE_LANG = 'genex_en.ts'
# Directory with locale files
LOCALE_DIR = 'src/qt/locale'
# Minimum number of messages for translation to be considered at all
MIN_NUM_MESSAGES = 10
# Regexp to check for Genex addresses
...
def contains_genex_addr(text, errors):
    if text != None and ADDRESS_REGEXP.search(text) != None:
<<<<<<< HEAD
        errors.append('Translation "%s" contains a genex address. This will be removed.' % (text))
=======
        #f-strings again
            ...
            for message in context.findall('message'):
                ...
                for translation in translations:
                    if translation is None:
                        continue
                    errors = []
                    valid = check_format_specifiers(source, translation, errors, numerus) and not contains_genex_addr(translation, errors)
