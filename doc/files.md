...
* genex.conf: contains configuration settings for genexd or genex-qt
* genexd.pid: stores the process id of genexd while running
...
* debug.log: contains debug information and general logging generated by genexd or genex-qt
