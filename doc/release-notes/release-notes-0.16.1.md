Genex Core version 0.16.1 is now available from:

  <https://genexcore.org/bin/genex-core-0.16.1/>
...
- #12843 `df38b13` Test starting genexd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure genexd processes are cleaned up when tests end (sdaftuar)
