Genex Core version 0.9.4 is now available from:

  https://genex.org/bin/0.9.4/
...
this update is incompatible with the Genex system and could lead to consensus
forks.

Genex Core released binaries from https://genex.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~genex/+archive/ubuntu/genex
- A third-party or self-compiled Genex Core

upgrade to Genex Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
