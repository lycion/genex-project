Genex version 0.5.4 is now available for download at:
http://sourceforge.net/projects/genex/files/Genex/genex-0.5.4/
...
http://gitorious.org/genex/genexd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Genex-Qt notifications under Growl 1.3.
Increase required age of Genex-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGenex properly when installing Genex-Qt over it. (Windows)
