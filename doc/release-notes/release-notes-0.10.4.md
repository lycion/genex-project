Genex Core version 0.10.4 is now available from:

  <https://genex.org/bin/genex-core-0.10.4/>
...
- #6953 `43c2789` Split genex-tx into its own package
- #6953 `dfe0d4d` Include genex-tx binary on Debian/Ubuntu
