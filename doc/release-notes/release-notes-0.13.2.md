Genex Core version 0.13.2 is now available from:

  <https://genex.org/bin/genex-core-0.13.2/>
...
- #8908 `4a974b2` Update genex-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow genex-tx to create v2 transactions (btcdrak)
