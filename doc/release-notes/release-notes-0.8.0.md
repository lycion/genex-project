Genex-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/genex/files/Genex/genex-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Genex
...
New/changed settings (command-line or genex.conf file)
--------------------------------------------------------
