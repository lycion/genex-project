...
This document provides guidelines for internationalization of the Genex Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `genex_en.ts` remains unchanged.
