...
#ifndef genex_TEST_SCRIPTNUM10_H
#define genex_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Genex Core 0.10.0, for cross-comparison.
 */
public:
