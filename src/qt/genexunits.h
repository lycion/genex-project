...
#ifndef genex_QT_genexUNITS_H
#define genex_QT_genexUNITS_H
...
/** Genex unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GenexUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GenexUnits(QObject *parent);

    /** Genex units.
      @note Source: https://en.genex.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef GenexUnits::Unit GenexUnit;

#endif // genex_QT_genexUNITS_H
