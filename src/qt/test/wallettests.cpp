...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<GenexAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_genex-qt -platform xcb      # Linux
//     src/qt/test/test_genex-qt -platform windows  # Windows
//     src/qt/test/test_genex-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = GenexUnits::formatWithUnit(unit, balance, false, GenexUnits::separatorAlways);
    ...
    // Amount input
    GenexAmountField* amountInput = receiveCoinsDialog.findChild<GenexAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: genex:")) != -1);
