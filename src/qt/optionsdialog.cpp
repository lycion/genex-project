    ...
    mapper(0)
{
    ...
    ui->genexAtStartup->setToolTip(ui->genexAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->genexAtStartup->setText(ui->genexAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openGenexConfButton->setToolTip(ui->openGenexConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new GenexUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->genexAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGenexConfButton_clicked()
{
