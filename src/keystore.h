...
#ifndef genex_KEYSTORE_H
#define genex_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/genex/bips/blob/master/bip-0013.mediawiki
