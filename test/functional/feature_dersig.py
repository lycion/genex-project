...
class BIP66Test(GenexTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # genexd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and genexd produces more specific reject
            # reasons.
