...
# TestP2PConn: A peer we use to send messages to genexd, and store responses.
...
class CompactBlocksTest(GenexTestFramework):
    ...
    # This test actually causes genexd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that genexd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for genexd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # genexd will not send blocktxn responses for blocks whose height is
