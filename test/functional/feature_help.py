#!/usr/bin/env python3
# Copyright (c) 2018 The Genex Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting genex with -h works as expected."""
import subprocess

from test_framework.test_framework import GenexTestFramework
from test_framework.util import assert_equal

class HelpTest(GenexTestFramework):
    ...
    def run_test(self):
        self.log.info("Start genex with -h for help text")
        ...
        self.log.info("Start genex with -version for version information")
        ...
        self.log.info("Start genexd with -fakearg to make sure it does not start")
