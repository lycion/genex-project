...
class SegWitTest(GenexTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older genexd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let genexd fill it in.
